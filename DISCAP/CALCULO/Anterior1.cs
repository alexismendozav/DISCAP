...
namespace Calculo
{
    public partial class Anterior1 : Form
    {
        private int posX;
        private int posY;
        ...
        {
            Anterior2 ventana = new Anterior2();
            ventana.Show();
        ...
        {
            string audioPath = Path.Combine(Application.StartupPath, "Incorrecto.wav");
        ...
        {
            string audioPath = Path.Combine(Application.StartupPath, "correcto.wav");
            SoundPlayer simpleSound = new SoundPlayer(audioPath);
            simpleSound.Play();
            correcto.Show();
        ...
        private void Anterior1_Load(object sender, EventArgs e)
        {
